...
type JobStatus =
  ...
  | "entregado"
  | "cobrado";
type CategoryDomain = "finance";
type CategoryDirection = "income" | "expense" | "both";
type FinancialTransactionType = "income" | "expense";
type FinancialTransactionStatus = "pending" | "paid" | "collected" | "void";
type PriceListStatus = "draft" | "previewed" | "imported" | "rolled_back";
type PriceImportStatus = "running" | "completed" | "failed" | "rolled_back";
type ImportStrategy =
  | "replace_prices"
  | "update_matched_only"
  | "create_missing"
  | "ignore_duplicates";
type PriceImportAction = "created" | "updated" | "ignored" | "failed";
type PriceImportMatchType = "code" | "description_supplier" | "none";

interface PeriodStampedRow {
  record_date: string;
  month: number;
  year: number;
  period_key: string;
    ...
    Tables: {
      ...
      settings: {
        Row: {
          ...
          default_income_tax_pct: number;
          default_vat_pct: number;
          default_profit_pct: number;
          indirect_costs_notes: string | null;
          is_active: boolean;
          notes: string | null;
          record_date: string;
          month: number;
      ...
      material_price_lists: {
        ...
        Update: Partial<Database["public"]["Tables"]["material_price_lists"]["Insert"]>;
      };
      material_price_imports: {
        Row: PeriodStampedRow & {
          ...
          rollback_of_import_id: string | null;
        ...
        Update: Partial<Database["public"]["Tables"]["material_price_imports"]["Insert"]>;
      };
      material_price_import_rows: {
        Row: PeriodStampedRow & {
          ...
          import_id: string;
          row_number: number;
          action: PriceImportAction | string;
          match_type: PriceImportMatchType | string;
          matched_material_id: string | null;
          raw_row: Json;
          normalized_row: Json;
          validation_errors: Json;
          previous_material_snapshot: Json | null;
          result_material_snapshot: Json | null;
          created_at: string;
          updated_at: string;
          created_by: string | null;
          updated_by: string | null;
